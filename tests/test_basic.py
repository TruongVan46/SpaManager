...
class BasicTestCase(unittest.TestCase):
    ...
    def test_statistics_page_renders_clean_vietnamese_labels_and_filter_links(self):
        ...
        self.assertIn('statistics-table-card', html)
        self.assertIn('statistics-table-header', html)
        self.assertIn('statistics-table-controls', html)
    ...
    def test_statistics_invalid_and_swapped_dates_do_not_break_report(self):
        ...
        self.assertIn("statistics-table-header", swapped_html)
